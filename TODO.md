...
- [x] Update documentation (v0.2)
- [ ] Better test the various options like`:run_once` to ensure they work properly (v0.3)
- [ ] Why do we handle {m, f, a}s differently for run_at and run_in? (v0.3)
- [x] Move the time handling strategies to the job